export const ru = {
    ...
    footer: {
        ...
        news:'Новости',
        contact: 'Контакты',
        text:'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sint quaerat ab placeat vitae tempora pariatur, minus soluta quos quas, iusto nobis enim iste commodi dolores, quasi dolorem rem debitis? Laborum?'
    },
    ...
    user: {
        notices: "Мои объявление",
        settings:'Настройки',
        profile: "Профиль",
        favs:"Избранные",
        logout:"Выйти",
        confirmText:"Вы хотите выйти?",
        favsNo:"Список избранных пусто",
        favsText:"Вы можете находить объявление в каталоге",
    ...
    msg: {
        ...
        newpassword:"Новый пароль не одинаково",
        updated:"Данные обновлено",
        minpassword:"Минимальная длина пароля 5 символов"
    }
}